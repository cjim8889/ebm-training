...
estimate, primals  = divergence_velocity_xtrace(mlp, pos, t, n_probes=n_probes, d=sigma)
print(f"Estimate: {estimate}")
print(f"Primals: {primals}")

estimate_hutchpp, _, primals_hutchpp = divergence_velocity_hutchpp(mlp, pos, t, d=sigma, n_probes=n_probes)
