...
initial_samples = path_density.sample_initial(key, (2560,))
...
save_path = "data/lj13c_smc_samples_posterior.npz" # Changed filename slightly
...
# Save the figure
fig_save_path = "lj13c_smc_samples_posterior.png" # Changed filename slightly
plt.show()
